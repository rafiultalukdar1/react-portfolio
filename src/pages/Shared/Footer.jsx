        ...
        <>
            <div className='mt-50'>
                <div className='container'>
                    <h2 className='font-rajdhani text-white text-[25px] sm:text-[30px] md:text-[35px] lg:text-[40px] font-bold capitalize'>Request <span className='text-[#FDB400]'>Information!</span></h2>

                    <div className='grid grid-cols-1 md:grid-cols-2 gap-5 gap-y-7.5 mt-6'>
                        <div>
                        ...
                        <div>
                            ...
                            <div className="relative max-w-110 w-full">
                                <form className="relative mt-3.75">
                                    ...
                                    <button type="submit" className="absolute top-0 right-0 h-full px-8 bg-[#FDB400] text-gray-900 font-semibold rounded-r flex items-center justify-center hover:opacity-90 font-titillium uppercase" ><FaPaperPlane className="mr-2.5" /> Send </button>
                                </form>
